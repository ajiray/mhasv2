        ...
        <form action="/create-post" method="POST">
            ...
            <div class="flex flex-col sm:flex-row sm:space-x-3 md:flex-row md:space-x-3 items-center">
                ...
                <button type="button" onclick="toggleOptions()"
                    class="w-[50%] py-2 sm:py-2 sm:w-[30%] md:py-2 md:w-[20%] xl:py-2 xl:w-[20%] mt-3 sm:mt-0 md:mt-0 xl:mt-0 rounded-lg bg-yellow hover:bg-amber-300 text-maroon font-semibold">
