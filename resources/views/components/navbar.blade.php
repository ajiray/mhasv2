...
<body>
    <nav class="bg-maroon flex items-center justify-between xl:w-full xl:bg-maroon h-[13%]">
                ...
                <div id="videocall" class="@if (request()->is('videocall')) active @endif">
                    <a href="/videocall">
                        <div class="flex gap-2 items-center">
                            ...
                            <p class="text-accent text-sm">VideoCall</p>
                        </div>
                    </a>
                </div>
        ...
        <div class="hidden xl:flex mr-10 justify-center items-center space-x-5">
            ...
            <div class="relative">
                ...
                <div id="notificationsContainer"
                    class="hidden absolute w-[390px] right-[-175px] md:top-0 md:right-0 md:mt-8 bg-white border border-gray-200 rounded-md shadow-md max-w-sm overflow-hidden md:w-96 z-50">
                    <div class="p-4">
                        @php
        ...
        <div id="settings"
            ...
            <button class="mx-4 my-2 px-4 py-2 bg-maroon text-white rounded hover:bg-red-700 w-full"
                href="{{ route('logout') }}"
                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                {{ __('Logout') }}
            </button>
