...
<body>
    <nav class="bg-guidancePrimary flex items-center justify-between xl:w-full xl:bg-guidancePrimary">
        ...
        <div class="flex h-full hidden xl:flex">
            <div class="flex space-x-16 justify-center items-center px-20">
                <div id="home" class="@if (request()->is('guidancedashboard')) active @endif">
                ...
                <div id="guidanceappointment" class="@if (request()->is('guidanceappointment')) active @endif">
                ...
                <div id="guidanceresources" class="@if (request()->is('guidanceresources')) active @endif">
        ...
        <div class="hidden xl:flex mr-10 justify-center items-center space-x-5">
            ...
            <img src="/images/profileM.png" alt="profile pic"
                class="w-24 h-24 rounded-full object-cover border-2 border-guidancePrimary cursor-pointer relative"
        ...
        <div id="settings"
            ...
            <button class="mx-4 my-2 px-4 py-2 bg-guidancePrimary text-white rounded hover:bg-red-700 w-full"
                href="{{ route('logout') }}"
                onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                {{ __('Logout') }}
            </button>
